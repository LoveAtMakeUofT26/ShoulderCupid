      ...
      <div className="max-w-6xl mx-auto px-6 pt-24 pb-16 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              <p className="text-sm font-bold text-cupid-500 tracking-widest uppercase mb-4">
            ...
            >
              <a href="http://localhost:3005" className="btn-glow inline-block text-center">
                Try Now
              </a>
              <Button
                variant="ghost"
          ...
          >
            <div className="relative">
              ...
              <div className="relative animate-float">
                {/* Cupid figure */}
                <div className="w-64 h-80 md:w-80 md:h-96 mx-auto rounded-3xl bg-gradient-to-b from-white via-marble-100 to-marble-200 border border-gold-100/50 shadow-marble flex flex-col items-center justify-center">
